<%@ Page Language="C#" AutoEventWireup="true" CodeFile="page_Monitor.aspx.cs" Inherits="Forms_page_Monitor" %>
...
<body>
    <form id="formMonitores" runat="server">
        <div>
            <table border="1" width="100%">
                <tr>
                    <td width="100%" align="center">
                        <asp:Label ID="lblLoja" runat="server" Text="MONITORES"></asp:Label>
                    </td>
                </tr>
            </table>
            &nbsp;

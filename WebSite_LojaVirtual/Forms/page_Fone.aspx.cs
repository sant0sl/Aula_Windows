...
public partial class Forms_page_Fone : System.Web.UI.Page
{
    ...
    public void carregarProdutos()
    {
        ...
        Produto p1 = new Produto(1, "Cloud Alpha", 300);
        lista_produtos.Add(p1);
        Produto p2 = new Produto(2, "Cloud Revolver", 400);
        lista_produtos.Add(p2);
        Produto p3 = new Produto(3, "Razer Kraken", 500);
        lista_produtos.Add(p3);
        Produto p4 = new Produto(4, "Razer Hammerhead", 600);

...
public partial class Forms_page_Mouse : System.Web.UI.Page
{
    ...
    public void carregarProdutos()
    {
        ...
        Produto p1 = new Produto(1, "Mamba", 300);
        lista_produtos.Add(p1);
        Produto p2 = new Produto(2, "DeathAdder", 400);
        lista_produtos.Add(p2);
        Produto p3 = new Produto(3, "Rapid", 500);
        lista_produtos.Add(p3);
        Produto p4 = new Produto(4, "Red Dragon", 600);

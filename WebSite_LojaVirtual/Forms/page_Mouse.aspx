<%@ Page Language="C#" AutoEventWireup="true" CodeFile="page_Mouse.aspx.cs" Inherits="Forms_page_Mouse" %>
...
<body>
    <form id="formMouses" runat="server">
        <div>
            <table border="1" width="100%">
                <tr>
                    <td width="100%" align="center">
                        <asp:Label ID="lblLoja" runat="server" Text="MOUSES"></asp:Label>
                    </td>
                </tr>
            </table>
            &nbsp;

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="page_Fone.aspx.cs" Inherits="Forms_page_Fone" %>
...
<body>
    <form id="formFone" runat="server">
        <div>
            <table border="1" width="100%">
                <tr>
                    <td width="100%" align="center">
                        <asp:Label ID="lblLoja" runat="server" Text="FONES"></asp:Label>
                    </td>
                </tr>
            </table>
            &nbsp;
